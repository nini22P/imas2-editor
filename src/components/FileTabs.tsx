            ...
            {openedFiles.map((file, index) => {
                ...
                return (
                    <div
                        key={file.path}
                        className={`
                            group flex items-center gap-1.5 px-3 h-full text-[12px] cursor-pointer transition-all duration-150 relative border-r
                        `}
                        style={{
                    ...
                    >
                        ...
                        <span className="truncate max-w-[130px]" title={file.path}>
                            {file.fileName}
                        </span>
                        <button
                            className={`
